...
export const INTEGRATIONS_TABLE = `
...
export const ALL_SCHEMAS = [SESSIONS_TABLE, MESSAGES_TABLE, CUSTOM_TOOLS_TABLE, SCHEDULED_TASKS_TABLE, TASK_RUNS_TABLE, INTEGRATIONS_TABLE];
...
export const ADD_TOOL_INTEGRATION_ID = `
ALTER TABLE custom_tools ADD COLUMN integration_id TEXT REFERENCES integrations(id) ON DELETE CASCADE;
`;

export const MIGRATIONS = [ADD_CONVERSATION_STATE, ADD_TASK_RUNS_OUTPUT, ADD_TOOL_INTEGRATION_ID];
